...
public class CompleteandAddTasksToDoList {
	...
	public CompleteandAddTasksToDoList(SharedResource sharedResource) throws InterruptedException {
	...
	@When("^Complete&Add-User enters a Task \"([^\"]*)\",\\\"([^\\\"]*)\\\",\\\"([^\\\"]*)\\\" and click enter$")
	...
	@Then("^Complete&Add-Click on the Completion tab and validate the task availability$")
	...
	@Then("^Complete&Add-Click on Clear Completed$")
	...
	@When("^Complete&Add-User adds Tasks \"([^\"]*)\",\\\"([^\\\"]*)\\\" and click enter$")
